                      ...
                      <div class="card-body card-block">
                        <div class="form-group">
                          <form name="formcategoria" action="#" method="POST">
                            ...
                            <input type="text" id="txtNomeCategoria" name="txtNomeCategoria" placeholder="Nome da Categoria" class="form-control">
                          </form>
                        </div>
                      </div>
                      <div class="card-footer">
                        <button id="salvar" onclick="CadastrarCategoria()" class="btn btn-outline-success">
                          Cadastrar
                        </button>
