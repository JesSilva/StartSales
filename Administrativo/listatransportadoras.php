...
<html lang="pt-br">
  <head>
    ...
    <!-- Titulo da Pagina -->
    <title>Painel de Controle - Transportadoras</title>
            ...
            <div class="main-content">
              <div class="section__content section__content--p30">
                <div class="container-fluid">
                  <div class="row">
                    <div class="col-md-12">
                      <h3 class="title-5 m-b-35">Transportadoras</h3>
                      <div class="table-data__tool">
                        ...
                        <div class="table-data__tool-right">
                          <button class="btn btn-outline-success">
                            <a href="modificartransportadoras.php">
                              Adicionar
                            </a>
                          </button>
                        </div>
                    ...
                    <div class="table-responsive table-responsive-data2">
                      <table class="table table-data2">
                        ...
                        <tbody>
                          <div>
                            <?php
                              //Chama a função responsável por buscar as transportadoras
